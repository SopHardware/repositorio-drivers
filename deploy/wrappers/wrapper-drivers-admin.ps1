# ============================================================
# Wrapper - Drivers Boxito Admin Portal (admin-portal)
# ============================================================
# Ejecutado por NSSM como proceso del servicio Windows.
# Lanza Node.js como proceso hijo y escribe TODOS los eventos
# al Visor de Eventos bajo Source="DriversAdmin".
# NSSM no escribe directamente al Event Log.
# ============================================================

$EventSource    = "DriversAdmin"
$EventLog       = "Application"
$AppDirectory   = "C:\inetpub\wwwroot\drivers-admin"
